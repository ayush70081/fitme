  ...
  return (
    ...
    >
      <div className="text-center mb-4">
        <MapPin className="h-10 w-10 text-pink-500 mx-auto mb-2" />
      ...
      <div className="mb-6">
        <input
          ...
          className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-colors duration-200"
      ...
      <div className="flex justify-between">
        ...
        <button
          ...
          className="bg-pink-500 text-white px-4 py-2 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed"
        >
          Next
        </button>
      </div>
